    ...
    <div>
        ...
        <div class="textBody">
            ...
            <table class="indexTable" id="tableFeaturedProducts">
                <tr>
                    <th colspan=3 style="font-size: 30px;">Hard Disk Drives (HDDs)</th>
                </tr>
                <tr>
                    <td>
                        <img class="tableImage" src="../images/websiteElements/catalogueIMGs/ssd/seagate1tb.png"><br>
                        Seagate BarraCuda 3.5" 1TB SATA3 Internal Hard Drive ST1000DM010
                        <br>
                        <br>
                        <b>RM159</b>
                    </td> 
                    <td>
                        <img class="tableImage" src="../images/websiteElements/catalogueIMGs/ssd/seagate2tb.png"><br>
                        Seagate BarraCuda 3.5" 2TB SATA3 Internal Hard Drive ST2000DM008
                        <br>
                        <br>
                        <b>RM229</b>
                    </td>
                    <td>
                        <img class="tableImage" src="../images/websiteElements/catalogueIMGs/ssd/seagate8tb.png"><br>
                        Seagate BarraCuda 3.5" 8TB SATA3 Internal Hard Drive ST8000DM004
                        <br>
                        <br>
                        <b>RM1339</b>
                    </td>
            ...
            <table class="indexTable" id="tableFeaturedProducts">
                <tr>
                    <th colspan=3 style="font-size: 30px;">Solid-state drives (SSDs)</th>
                </tr>
                <tr>
                    <td>
                        <img class="tableImage" src="../images/websiteElements/catalogueIMGs/ssd/pnycs900.png"><br>
                        PNY CS900 M.2 SATA III 500GB Internal Solid State Drive 
                        <br>
                        <br>
                        <b>RM99</b>
                    </td>
                    <td>
                        <img class="tableImage" src="../images/websiteElements/catalogueIMGs/ssd/860evo.png"><br>
                        Samsung 860 EVO M.2 SATA 500GB Internal SSD 550MB/s MZ-N6E500BW
                        <br>
                        <br>
                        <b>RM355</b>
                    </td>
                    <td>
                        <img class="tableImage" src="../images/websiteElements/catalogueIMGs/ssd/p400.png"><br>
                        Patriot P400 1TB M.2 2280 PCIe Gen4 NVMe SSD P400P1TBM28H
                        <br>
                        <br>
                        <b>RM649</b>
                    </td> 
