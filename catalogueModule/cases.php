    ...
    <div>
        ...
        <div class="textBody">
            ...
            <table class="indexTable" id="tableFeaturedProducts">
                ...
                <tr>
                    <td>
                        <img class="tableImage" src="../images/websiteElements/catalogueIMGs/cases/tecware.png"><br>
                        Tecware Forge S TG ARGB ATX Black Gaming Case
                        <br>
                        <br>
                        <b>RM185</b>
                    </td>
                    <td>
                        <img class="tableImage" src="../images/websiteElements/catalogueIMGs/cases/cmmasterbox.png"><br>
                        Cooler Master MasterBox TD500 ARGB Mesh ATX Case Black 
                        <br>
                        <br>
                        <b>RM365</b>
                    </td>
                    <td>
                        <img class="tableImage" src="../images/websiteElements/catalogueIMGs/cases/cmh500p.png"><br>
                        Cooler Master MasterCase H500P ARGB Mesh Mid Tower ATX Case Black
                        <br>
                        <br>
                        <b>RM559</b>
                    </td> 
            ...
            <table class="indexTable" id="tableFeaturedProducts">
                ...
                <tr>
                    <td>
                        <img class="tableImage" src="../images/websiteElements/catalogueIMGs/cooling/thermalright.png"><br>
                        Thermalright TL-C12015 120mm Cooling Fan - Black
                        <br>
                        <br>
                        <b>RM55</b>
                    </td>
                    <td>
                        <img class="tableImage" src="../images/websiteElements/catalogueIMGs/cooling/corsaircooler.png"><br>
                        Corsair iCUE SP140 RGB PRO Performance 140mm Fan
                        <br>
                        <br>
                        <b>RM119</b>
                    </td>
                    <td>
                        <img class="tableImage" src="../images/websiteElements/catalogueIMGs/cooling/corsaircooler2.png"><br>
                        Corsair iCUE QL140 RGB PWM White 140mm Fan 
                        <br>
                        <br>
                        <b>RM179</b>
                    </td> 
