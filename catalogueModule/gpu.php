    ...
    <div>
        ...
        <div class="textBody">
            ...
            <table class="indexTable" id="tableFeaturedProducts">
                <tr>
                    <th colspan=3 style="font-size: 30px;">Graphic Cards (GPU)</th>
                </tr>
                <tr>
                    <td>
                        <img class="tableImage" src="../images/websiteElements/catalogueIMGs/gpu/gtx1660.png"><br>
                        INNO3D GeForce GTX 1660 Twin X2 6GB GDDR5 Non OC Graphics Card N16602-06D5-1521VA15L
                        <br>
                        <br>
                        <b>RM939</b>
                    </td>
                    <td>
                        <img class="tableImage" src="../images/websiteElements/catalogueIMGs/gpu/rtx3050.png"><br>
                        Palit GeForce RTX 3050 Dual OC 8GB GDDR6 Graphics Card NE63050T19P1-190AD
                        <br>
                        <br>
                        <b>RM1599</b>
                    </td>
                    <td>
                        <img class="tableImage" src="../images/websiteElements/catalogueIMGs/gpu/rtx4070ti.png"><br>
                        Palit GeForce RTX 4070 Ti Gaming Pro 12GB GDDR6X Video Card NED407T019K9-1043A
                        <br>
                        <br>
                        <b>RM3919</b>
                    </td> 
